    ...
    html! {
        <div style={props.container_style}>
            <div style={props.rectangle_style}>
                <div style={props.star_style}>
                    { render_svg("rgba(255, 255, 255, 0.12)") }
                </div>
            </div>
            <div style={props.rectangle1_style} />
            <div style={props.star2_style}>
                { render_svg("rgba(139, 77, 255, 0.1)") }
            </div>
            <div style={props.star1f_style}>
                <i class="fa-solid fa-star" style="font-size: 240px; color: rgba(105, 71, 255, 0.12); opacity: 0.7;" />
            </div>
        </div>
    }
}
...
pub struct HeroTitleProps {
    ...
    #[prop_or("Build ")]
    pub drive_text: &'static str,

    #[prop_or("Apps")]
    pub growth_text: &'static str,

    #[prop_or(" ")]
    pub empty_text: &'static str,

    #[prop_or("Blazingly Fast")]
    pub through_text: &'static str,
}
...
pub fn hero_title(props: &HeroTitleProps) -> Html {
    html! {
        <h1 style={props.style} class={props.class} id="hero-title">
            <span style={props.drive_style} class={props.drive_class}>{ props.drive_text }</span>
            <span style={props.growth_style} class={props.growth_class}>{ props.growth_text }</span>
            <span style={props.empty_style} class={props.empty_class}>{ props.empty_text }</span>
...
pub fn hero_description(props: &HeroDescriptionProps) -> Html {
    html! { <p style={props.style} class={props.class}>{ props.text }</p> }
}
...
pub struct CompaniesProps {
    ...
    #[prop_or("Trusted by teams building the future with Open SASS")]
...
pub fn companies(props: &CompaniesProps) -> Html {
    html! {
        <div style={props.style} class={props.class}>
            <p style={props.title_style} class={props.title_class}>{ props.title_text }</p>
...
pub struct HeroProps {
    #[prop_or(
        "display: flex; flex-direction: column; align-items: center; flex-wrap: nowrap; gap: 42px; position: absolute; width: 734px; height: 288px; top: 173px; left: 50%; transform: translate(-50%, 0); z-index: 16;"
    )]
    pub style: &'static str,
    #[prop_or_default]
    pub class: &'static str,
